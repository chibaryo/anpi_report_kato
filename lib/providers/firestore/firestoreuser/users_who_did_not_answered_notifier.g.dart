...
abstract class _$StreamAnsOrNotAnsNotificationCombinedNotifier
  ...
  Stream<Map<String, List<Map<String, dynamic>>>> build(
    String notiId,
  );
}
...
class StreamAnsOrNotAnsNotificationCombinedNotifierProvider
  ...
  @override
  Stream<Map<String, List<Map<String, dynamic>>>> runNotifierBuild(
  ...
  AutoDisposeStreamNotifierProviderElement<
      StreamAnsOrNotAnsNotificationCombinedNotifier,
      Map<String, List<Map<String, dynamic>>>> createElement() {
