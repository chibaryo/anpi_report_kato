...
import '../../../components/topic_dropdown.dart';
...
class NotiAdminScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final sqlUsersNotifier =
        ref.read(unansweredUsersSQLiteNotifierProvider.notifier);
    ...
    final notiStreamNotifier =
        ref.watch(streamNotificationNotifierProvider.notifier);
    ...
    final String apiSrvEndpoint = dotenv
        .get('APISRV_BASEURL'); //"eD8dzYgLNtF4HmmOB9OT3i7Y1G5wXyeeAn4unMBA";
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TopicDropdown(
                              value: selectedNotiTopic.value,
                              onChanged: (value) {
                                selectedNotiTopic.value = value!;
                                debugPrint("Selected topic: $value");
                              },
...
*/
                  ...
                  TextButton(
                    onPressed: () async {
                      ...
                      final String apiEndpoint =
                          "$apiSrvEndpoint/api/sendToTopic";
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            actions: (() {
              if (moiProfile.value != null &&
                  moiProfile.value!.userAttr["jobLevel"] >= 4) {
                return <Widget>[
                  IconButton(
                      onPressed: () async {
                        ...
                        return DataRow(
                            onSelectChanged: (bool? selected) async {
                              if (selected != null && selected) {
                                ...
                                context.router.push(NotiAdminDetailsRoute(
                                    notiId: rowRecord.notificationId));
                              }
                            },
                            cells: [
                              moiProfile.value != null &&
                                      moiProfile.value!.userAttr["jobLevel"] >=
                                          4
                                  ? DataCell(TextButton(
                                      onPressed: () async {
                                  ...
                                  : const DataCell(Text("")),
                              DataCell(Text(DateFormat('[MM/dd HH:mm]')
                                  .format(rowRecord.createdAt))),
